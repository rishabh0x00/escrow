...
contract Escrow is Ownable2StepUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /**
     * @notice Thrown when amount of funds to release is zero.
     */
    error ZeroAmountOfFundsToRelease();
     ...
     * @custom:error ZeroAmountOfFundsToRelease is thrown if input deposit id funds have zero amount to release.
     * @custom:event FundsReleased emits on success.
     */
